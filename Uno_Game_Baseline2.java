...
public class Uno_Game_Baseline2 {
	...
	public static void main(String[] args) {
		...
		while ((User_Hand.isEmpty() == false) && (AI_Hand.isEmpty() == false)) {
			...
			while (Move_Check == false) {
				...
				// Display Opponent Hand Size
				System.out.printf("\nOpponent hand size: %d\n", AI_Hand.size());
				...
				String Input_Val = User_Input.nextLine();
			...
			while (AI_Check == false) {
				...
				String Input_Val = AI_Agent(AI_Hand, Top_Card);
		...
		Win_Condition(User_Hand, AI_Hand);
		
	}// End of main
	
	// Decides the winner of the game
	public static void Win_Condition(ArrayList<Cards> User, ArrayList<Cards> AI) {
		if (User.isEmpty()) {
			System.out.println("You Win!");
		}else if (AI.isEmpty()) {
			System.out.println("Baseline2 Wins!");
		}
	}
	...
	public static String AI_Agent(ArrayList<Cards> AI, Cards Current_Card) {
